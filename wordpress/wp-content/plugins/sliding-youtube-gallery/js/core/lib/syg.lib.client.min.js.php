...
$target_dir = WP_CONTENT_DIR . SygConstant::WP_CACHE_JS_REL_DIR;
...
if(file_exists($target_dir.$name)) {
    ...
    // write information to log
    if (SygConstant::SYG_DEBUG_MODE) {
        $log->lwrite('Getting syg.lib.client.min.js content >>>>>>');
    }
	...
	if(isset($_REQUEST['minify'])) {
        ...
        // write information to log
        if (SygConstant::SYG_DEBUG_MODE) {
            $log->lwrite('File not exists, I will create reading syg.lib.admin.js.php through a minification request');
        }
